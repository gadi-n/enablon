...
def delete_task_text(browser, textbox_element, action_chains, task_text, elements):
    """
    ...
    :param elements: dict, elements file
...
def get_task_elements_by_status(browser, status, elements):
    """
    ...
    return browser.find_elements(By.XPATH, elements['task_element'])
